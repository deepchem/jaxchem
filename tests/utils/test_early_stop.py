...
class TestEarlyStopping(unittest.TestCase):
    ...
    def test_is_train_stop(self):
        ...
        early_stop.update(init_score, None)
        for i in range(5):
            assert early_stop.is_train_stop is False
            early_stop.update(i, None)
